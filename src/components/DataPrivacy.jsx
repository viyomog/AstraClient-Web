...
const DataPrivacy = () => {
    return (
        <section className="section" style={{ backgroundColor: 'var(--bg-card)', padding: '5rem 0', borderTop: '1px solid var(--border)' }}>
            <div className="container" style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
                ...
                <Link to="/privacy" className="btn btn-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.75rem 2rem', textDecoration: 'none', borderRadius: '8px', border: '1px solid var(--primary)', color: 'var(--primary)' }}>
